...
# language: Python 3.13+, file: jareth.py, framework: Kivy 2.3+
# flappy bird — "Jareth Adventure"
# intro + START · pausa · salto por toque · imagen grande con hitbox aparte · fondo rojo
...
class Bird(Widget):
    ...
    def __init__(self, **kw):
        ...
        self.disabled = True   # no intercepta toques

        # mipmap sí es propiedad válida de Image en Kivy 2.3
        # mag_filter / min_filter NO existen — quitados
...
class FlappyGame(FloatLayout):
    ...
    def __init__(self, on_game_over, **kw):
        super().__init__(**kw)
